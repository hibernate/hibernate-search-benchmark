    ...
    stages {
        ...
        stage('Performance test') {
            steps {
                ...
                sh 'docker run --rm=true --name postgresql-search5-lucene -p 5431:5432 -e POSTGRES_USER=username -e POSTGRES_PASSWORD=password -e POSTGRES_DB=database -d postgres:13.3'
